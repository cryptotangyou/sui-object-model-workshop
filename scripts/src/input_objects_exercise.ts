...
const main = async () => {
  ...
  console.log("\nView the Counter object:");
  console.log(`https://suiscan.xyz/testnet/object/${COUNTER_OBJECT_ID}`);
  ...
  //https://suiscan.xyz/testnet/tx/FQC6Kzjr4z4uTEWJAiZbKtCbBcQ7Eik8shHXPWoopW6J
};
